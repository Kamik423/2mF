...
LOCK STEERING TO - SHIP:VELOCITY:SURFACE:NORMALIZED * landingpad:POSITION:MAG - VXCL(SHIP:VELOCITY:SURFACE, VXCL(SHIP:UP:FOREVECTOR, landingpad:POSITION * 1.42 - impactPoint(8)))*8. 

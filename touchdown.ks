...
WAIT UNTIL SHIP:ALTITUDE - landingpad:TERRAINHEIGHT < 0.5 * ( SHIP:VERTICALSPEED ^ 2 / (SHIP:MAXTHRUST / SHIP:MASS - 9.81)). 
...
LOCK STEERING TO LOOKDIRUP( steeringVector + SHIP:UP:FOREVECTOR:NORMALIZED * 35, HEADING(90,0):FOREVECTOR).
LOCK THROTTLE TO 1.
